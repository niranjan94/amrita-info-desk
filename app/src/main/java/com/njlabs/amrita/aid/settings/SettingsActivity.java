package com.njlabs.amrita.aid.settings;
...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        //prefHeader.setTitle(R.string.pref_header_personal_details);
        ...
        prefHeader.setTitle(R.string.pref_header_explorer);
        getPreferenceScreen().addPreference(prefHeader);
        addPreferencesFromResource(R.xml.pref_explorer);

        // Add 'data and sync' preferences, and a corresponding header.
        prefHeader = new PreferenceCategory(this);
        prefHeader.setTitle(R.string.pref_header_libraries_used);
        getPreferenceScreen().addPreference(prefHeader);
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class PersonalDetailsFragment extends PreferenceFragment {
        @Override
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class AmritaExplorerFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_explorer);
